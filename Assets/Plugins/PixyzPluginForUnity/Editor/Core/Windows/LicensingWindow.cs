...
namespace Pixyz.Plugin4Unity.EditorWindows
{
    ...
    public class LicensingWindow : SingletonEditorWindow {
        ...
        private Native.Core.WebLicenseInfo licenseToProcess;
        ...
        private void drawOnline() {
            ...
            var currentLicense = Native.NativeInterface.GetCurrentLicenseInfos();
            ...
            for (int r = 0; r < licenses.Length; r++) {
                ...
                Native.Core.WebLicenseInfo license = licenses[r];
