...
{ 
    public class AboutWindow : SingletonEditorWindow
    {
        ...
        public static void ShowLicenseInfos(bool boxes = true)
        {
            ...
            if (Native.NativeInterface.IsFloatingLicense()) 
            {
                if (Configuration.CheckLicense())
                {
                    var currentLicenseServer = Native.NativeInterface.GetLicenseServer();
                ...
                var currentNodeLockedLicense = Native.NativeInterface.GetCurrentLicenseInfos();
            ...
            if (Configuration.CheckLicense()) {
                ...
                if (hasLicense && Configuration.CustomVersionTag == "BETA_VERSION" && !Native.NativeInterface.IsTokenValid("Beta")) {
                    EditorGUILayout.BeginVertical("helpBox");
