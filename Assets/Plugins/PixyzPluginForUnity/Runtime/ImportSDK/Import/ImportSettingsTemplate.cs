...
namespace Pixyz.ImportSDK
{
    ...
    public struct ImportSettingsTemplate {
        ...
        public static readonly ImportSettingsTemplate Default = new ImportSettingsTemplate {
            ...
            isZUp = new Parameter<bool> { defaultValue = false, name = "Flip XY axis", tooltip = "Force the rotation of your model to 90° on X axis." },
            mergeFinalLevel = new Parameter<bool> { defaultValue = false, name = "Merge Final Level", tooltip = "Merge objects on the last levels of the hierarchy. This will for instance merge brep patches contained in the same geometrical set.Use this setting to assemble together unconnected CAD surfaces." },
